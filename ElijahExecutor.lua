--[[ Kick Message ]] --
game:GetService("Players").LocalPlayer:Kick("Elijah Executor Hasnt Released Yet! Its Still In Development Please Wait For The Release");
...
nameLabel.Text = "Elijah Executor | Android"
